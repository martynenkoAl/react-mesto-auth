...
function AddPlacePopup ({onClose, onAddPlace, isLoading, isOpen}) {
    ...
    return (
        <PopupWithForm title="Новое место" name="cards" btntext={isLoading ? 'Создание...' : 'Создать'} isOpen={isOpen} onClose={onClose} onSubmit={handleSubmit}>
